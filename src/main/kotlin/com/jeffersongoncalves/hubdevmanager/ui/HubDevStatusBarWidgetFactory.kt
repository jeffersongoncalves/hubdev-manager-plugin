...
class HubDevStatusBarWidgetFactory : StatusBarWidgetFactory {
    ...
    override fun createWidget(project: Project): StatusBarWidget = HubDevStatusBarWidget(project)
...
class HubDevStatusBarWidget(private val project: Project) :
    ...
    override fun getTooltipText(): String {
        val service = HubDevSiteService.getInstance(project)
        return if (service.isLinked) {
            service.siteUrl() ?: "HubDev: Linked"
        } else {
            "HubDev: Click to manage"
        }
    }

    override fun getIcon(): Icon {
        val service = HubDevSiteService.getInstance(project)
        return if (service.isLinked) HubDevIcons.LINKED else HubDevIcons.UNLINKED
    }
